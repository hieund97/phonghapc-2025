...
<section class="container container-customer">
    ...
    @endphp
@if($images)
        <div class="phonghacompu-customer">
            <div class="phonghacompu-customer-img-fix">
{{--                <img class="img-fluid" src="{{ $images[0]['url'] }}" alt="Customer first" width="1" height="1"--}}
{{--                     style="width: auto;height: auto; max-width: 95%">--}}
            </div>
            <div class="wrap-phonghacompu-customer">
                <div class="phonghacompu-customer-title">Sự ủng hộ của khách hàng khắp mọi miền đất nước</div>
