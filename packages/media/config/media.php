...
return [
    ...
    'sizes'                   => [
        'default'       => '345x345',
        'detail'        => '500x500',
        'full_featured' => '578x300',
        'featured'      => '426x221',
        'thumb'         => '150x150',// thumb không được cái này đâu nhé. core đấy
        'smallest'      => '55x55',
        'slider_home'   => '800x300',
        'banner_home'   => '398x100',
        'product_hot'   => '690x345',
    ...
    'allowed_mime_types'      => env('RV_MEDIA_ALLOWED_MIME_TYPES',
        'JPG,jpg,jpeg,png,gif,txt,docx,zip,mp3,bmp,csv,xls,xlsx,ppt,pptx,pdf,mp4,doc,webp,svg'),
    'mime_types'              => [
        'image'    => [
            'image/png',
            'image/jpeg',
